...
def screenshot() -> None:
    ...
    img.save("path of the folder you want to save/screenshot.png")

#Gives the percentage of CPU and battery of the computer
def cpu() -> None:
...
# JARIVS gives the weather report
def weather():
...
# JARVIS will make sure he heard you
def translate(word):
    word = word.lower()
    if word in data:
        speak(data[word])
