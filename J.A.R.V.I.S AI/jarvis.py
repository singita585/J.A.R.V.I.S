# imports that are needed for Jarvis voice
import pyttsx3
import wikipedia
...
class Jarvis:
    ...
    # In this section of code, the AI greets the User
    ...
    def execute_query(self, query):
        ...
        #This section of code deals with changing the voice of the AI from male to a female 
        elif 'voice' in query:
            if 'female' in query:
       ...
       #This section deals with accessing the internet and to search for what are you looking for
            ...
            if platform == "win32" or "darwin":
                speak('Singita is my master. He created me couple of days ago')
       ...
       # This section of code deals with sending an email
        elif 'email to Singita' in query:
            try:
...
if __name__ == '__main__':
    ...
    while True:
        ...
        for(x,y,w,h) in faces:
            ...
            cv2.rectangle(img, (x,y), (x+w,y+h), (0,255,0), 2) #this code is used to draw a rectangle on any image
            id, accuracy = recognizer.predict(converted_image[y:y+h,x:x+w]) #this code is to predict on every single image
